...
namespace Yammi\JobsMonitor\Infrastructure\Persistence\Transfer;
...
final class EloquentMonitorDataTransferrer implements MonitorDataTransferrer
{
    /**
     * Insert order: parents before children so insertOrIgnore never hits a
     * missing FK row. DROP order is reversed — see transfer().
     *
     * @var list<string>
     */

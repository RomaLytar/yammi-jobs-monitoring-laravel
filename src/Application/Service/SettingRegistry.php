            ...
            'general' => [
                ...
                'settings' => [
                    ...
                    new SettingDefinitionData(
                        ...
                        description: 'Number of days to keep historical data — job records, failure groups, scheduled-task runs and duration anomalies. The jobs-monitor:prune command (scheduled daily) deletes everything older. Lower values free disk space faster but reduce historical visibility. Worker heartbeats keep their own shorter retention.',
                        min: 7,
                        max: 1825,
                        suffix: 'days',
                    ),
            ...
            'workers' => [
                ...
                'settings' => [
                    ...
                    new SettingDefinitionData(
                        ...
                        description: 'Number of days to keep worker heartbeat records. The jobs-monitor:prune command deletes older rows. Heartbeats are high-volume, so a short retention is usually right — you mainly care about the last few days.',
                        min: 7,
                        max: 365,
                        suffix: 'days',
                    ),

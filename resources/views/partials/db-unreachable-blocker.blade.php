<div class="fixed inset-0 z-50 flex items-center justify-center bg-background/95 backdrop-blur-sm px-4 overflow-y-auto">
    <div class="w-full max-w-lg rounded-2xl border border-border bg-card text-card-foreground shadow-2xl my-8">
        ...
        <div class="space-y-4 px-8 pb-8">
            ...
            <div class="rounded-xl border border-border bg-muted/30 p-5 space-y-3">
                ...
                <p class="text-xs text-muted-foreground">
                    Remove or clear the env variable to use your app's default database again:
                </p>
